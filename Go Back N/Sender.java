...
public class Sender extends Thread {
    ...
    public static void main(String[] args) {
        if (Integer.parseInt(args[4]) > 128 && Integer.parseInt(args[5]) < 0) {
            System.out.println("Window size is invalid. It must be less than 129 and bigger than or equal to 0.");
            System.exit(0);
        }
        ...
        new Sender(args[0], args[1], args[2], args[3], args[4], args[5]).start();
    }
    ...
    Sender(String ad, String dp, String sp, String rn, String n, String filename) {
        try {
    ...
    public void run() {
        try {
            ...
            System.out.println("All data successfully sent from "+f);
